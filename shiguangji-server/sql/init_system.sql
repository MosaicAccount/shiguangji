-- 拾光记系统基础表与初始数据
-- 执行顺序：init_system.sql -> quartz.sql -> init_business.sql
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1, 'admin', 'admin', '00', 'sgj@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2, 'shiguangji',    '时光机', '00', 'sgj@qq.com',  '15666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_role values('2', '普通角色',    'common', 2, 1, '0', '0', 'admin', sysdate(), '', null, '普通角色');
