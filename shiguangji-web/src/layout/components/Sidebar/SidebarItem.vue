...
import { getNormalPath } from '@/utils/sgj'

/** 侧边栏菜单路由（store 生成的路由树节点） */
interface MenuRoute {
  path: string
  hidden?: boolean
  alwaysShow?: boolean
  ...
  meta?: { title?: string; icon?: string; link?: string }
  children?: MenuRoute[]
}
...
const onlyOneChild = ref<MenuRoute>({} as MenuRoute)

function hasOneShowingChild(children?: MenuRoute[], parent?: MenuRoute) {
