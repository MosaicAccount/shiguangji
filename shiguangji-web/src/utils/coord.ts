/**
 * GCJ-02（高德/火星坐标）与 WGS-84（GPS 真实坐标）互转，标准公开算法。
 * 地图选点用高德瓦片（GCJ-02 显示空间），表单与数据库存 WGS-84，出入显示层各转一次。
 */
