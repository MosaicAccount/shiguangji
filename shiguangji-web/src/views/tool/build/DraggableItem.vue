...
const props = defineProps({
  element: { type: Object as PropType<Record<string, any>>, required: true },
  index: { type: Number, default: 0 },
  drawingList: { type: Array as PropType<Record<string, any>[]>, default: () => [] },
  activeId: { type: [String, Number], default: '' },
  formConf: { type: Object as PropType<Record<string, any>>, required: true }
})
const className = ref('')
...
function deleteItem(item: number | Record<string, any>, parent?: Record<string, any>[]): void {
