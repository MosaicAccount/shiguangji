...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/front/movie/index.vue'),
        name: 'FrontMovie',
        meta: { title: '影视' }
      }
    ]
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/front/book/index.vue'),
        name: 'FrontBook',
        meta: { title: '读书' }
      }
    ]
  ...
  },
  {
    ...
    children: [
      {
        path: '',
        component: () => import('@/views/business/item/index.vue'),
        name: 'BusinessItem',
        meta: { title: '全部条目', icon: 'list' }
      }
    ]
  },
  {
